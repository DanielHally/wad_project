...
urlpatterns = [
    ...
    path('shop/<slug:shop_name_slug>/edit_review/<int:review_id>', views.edit_review, name='edit_review'),
    path('shop/<slug:shop_name_slug>/delete_review/<int:review_id>', views.delete_review, name='delete_review'),
